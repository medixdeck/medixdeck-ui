...
export const Testimonial: StoryObj<typeof TestimonialCard> = {
  args: {
    ...
    role: 'Patient, Lagos',
    quote:
      'MedixDeck connected me with a specialist in under 5 minutes. I can now manage my diabetes properly from home.',
    rating: 5,
  },
};
...
export const Blog: StoryObj<typeof BlogCard> = {
  ...
  args: {
    ...
    excerpt:
      "Learn key signs and symptoms that warrant immediate medical attention, plus tips on navigating Nigeria's healthcare options effectively.",
