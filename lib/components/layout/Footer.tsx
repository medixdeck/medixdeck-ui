...
const FOOTER_COLORS: Record<FooterColorScheme, { solid: string; solidHover: string; token: string; focusRing: string }> = {
  blue: { solid: "#0685FF", solidHover: "#0066CC", token: "blue.500", focusRing: "var(--chakra-colors-blue-500)" },
  purple: { solid: "#7700CC", solidHover: "#5C00A3", token: "purple.500", focusRing: "var(--chakra-colors-purple-500)" },
};
