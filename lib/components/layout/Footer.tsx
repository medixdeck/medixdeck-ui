...
const FOOTER_COLORS: Record<
  FooterColorScheme,
  { solid: string; solidHover: string; token: string; focusRing: string }
> = {
  blue: {
    solid: '#0685FF',
    solidHover: '#0066CC',
    token: 'blue.500',
    focusRing: 'var(--chakra-colors-blue-500)',
  },
  purple: {
    solid: '#7700CC',
    solidHover: '#5C00A3',
    token: 'purple.500',
    focusRing: 'var(--chakra-colors-purple-500)',
  },
};
...
export interface FooterProps extends Omit<BoxProps, 'children'> {
  ...
  /**
   * Brand accent applied to logo, social icons, newsletter button, and link hover states.
   * @default "blue"
   */
...
const SocialIcons = (iconColor: string) => ({
  facebook: (
    <svg width="26" height="26" viewBox="0 0 26 26" fill="none" xmlns="http://www.w3.org/2000/svg">
      <rect width="26" height="26" rx="5" fill={iconColor} />
      <g clipPath="url(#clip0_1217_192)">
        <path
          d="M11.0972 21V13.4923H9.112V10.7892H11.0972V8.4804C11.0972 6.66611 12.2698 5 14.9719 5C16.0659 5 16.8749 5.10488 16.8749 5.10488L16.8111 7.62914C16.8111 7.62914 15.9861 7.6211 15.0858 7.6211C14.1114 7.6211 13.9553 8.07014 13.9553 8.81544V10.7892H16.8886L16.761 13.4923H13.9553V21H11.0972Z"
          fill="white"
        />
      </g>
      <defs>
  ...
  twitter: (
    <svg width="26" height="26" viewBox="0 0 26 26" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      <g clipPath="url(#clip0_1217_186)">
        <path
          d="M14.8963 11.3512L20.3606 5H19.0656L14.3213 10.515L10.5319 5H6.16125L11.8913 13.3394L6.16125 20H7.45625L12.4663 14.1763L16.4681 20H20.8388L14.8963 11.3512ZM13.1231 13.4131L12.5425 12.5825L7.9225 5.975H9.91125L13.6394 11.3075L14.22 12.1381L19.0663 19.0694H17.0775L13.1231 13.4131Z"
          fill="white"
        />
      </g>
      <defs>
...
const defaultDescription =
  "Nigeria's leading digital platform for specialist healthcare. Bridging the gap between expert care and patient convenience.";
...
const defaultSocialLinks: SocialLink[] = [
  ...
  { platform: 'whatsapp', href: (import.meta as unknown as { env?: Record<string, string> }).env?.VITE_WHATSAPP_COMMUNITY_LINK ?? 'https://chat.whatsapp.com/GZGcTWtpVHHKUIKzJz3owC' },
...
export function Footer({
  ...
  return (
    <Box as="footer" bg="bg" py={{ base: 12, md: 16 }} {...props}>
      <Container maxWidth="7xl">
        ...
        >
          ...
          <Box>
            ...
            <HStack mt={6} gap={2} flexWrap="wrap">
              {(() => {
                const icons = SocialIcons(scheme.solid);
              ...
              >
                ...
                >
                  {newsletter?.description ??
                    'Get monthly health tips from our verified specialists.'}
                </Text>
                ...
                <Box as="form" onSubmit={handleNewsletterSubmit} position="relative" display="flex">
                  <Box
                    ...
                    _focus={{
                      outline: 'none',
                      borderColor: scheme.token,
                      boxShadow: `0 0 0 1px ${scheme.solid}`,
                    }}
                    transition="all 0.2s"
                    required
                  />
        ...
        {certifications && certifications.length > 0 && (
          <Box borderTop="1px solid" borderColor="border" pt={6} mt={6} pb={0}>
            <Flex
              gap={{ base: 6, md: 10 }}
              flexWrap="wrap"
            ...
            >
              {certifications.map((cert) => {
                ...
                if (cert.href) {
                  return (
                    <Box key={cert.name}>
                      {renderLink({ href: cert.href, isExternal: cert.isExternal ?? true }, badge)}
                    </Box>
                  );
                }
