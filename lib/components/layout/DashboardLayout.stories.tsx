  ...
  return (
    <Box p={8}>
      ...
      <Box p={8} bg="bg.surface" borderRadius="xl" border="1px dashed" borderColor="border">
        <Text color="text.muted" fontSize="sm">Your dashboard content goes here.</Text>
      </Box>
    </Box>
  );
}
...
export const ScoreCardBronzeTier: Story = {
  ...
  render: (args) => (
    <Box h="100vh" w="100%">
      <DashboardLayout {...args}>
        <PageContent title="Bronze tier" description="Warm copper ring + dark amber label (#92400E)." />
      </DashboardLayout>
    </Box>
  ),
};
...
export const ScoreCardPlatinumTier: Story = {
  ...
  render: (args) => (
    <Box h="100vh" w="100%">
      <DashboardLayout {...args}>
        <PageContent title="Platinum tier" description="Sky-blue ring + info blue label (#0284C7)." />
      </DashboardLayout>
    </Box>
  ),
};
